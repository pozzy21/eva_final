...
def choice_type_of_cover():
    buttons = [
        ...
        [InlineKeyboardButton(
            text="5", callback_data="5_type"),
         InlineKeyboardButton(
            text="6", callback_data="6_type"),
         InlineKeyboardButton(
            text="7", callback_data="7_type")],
...
def choice_type_of_pyatka():
    buttons = [
        [
            InlineKeyboardButton(text="П-30", callback_data="P-30"),
            InlineKeyboardButton(text="П-20", callback_data="P-20"),
            InlineKeyboardButton(text="П-40", callback_data="P-40"),
        ],

        [InlineKeyboardButton(text="Мне нужна помощь",
                              callback_data="help10")],
        [InlineKeyboardButton(text="Не нужен", callback_data="None")],
        [InlineKeyboardButton(text="Назад", callback_data="back_to_input_10")]
    ]
    keyboard = InlineKeyboardMarkup(inline_keyboard=buttons)
    return keyboard
...
def order_11_kb():
    buttons = [
        [InlineKeyboardButton(text='Нужны', callback_data="yes_shield"),
         InlineKeyboardButton(text='Не нужны', callback_data="no_shield")],
        [InlineKeyboardButton(text="Мне нужна помощь",
